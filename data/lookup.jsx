...
export default {
  ...
  HERO_HEADING: "What you want to build Today?",
  HERO_DESC:
    "Effortlessly build, deploy, and scale full-stack web applications from start to finish.",
  INPUT_PLACEHOLDER: "Tell us what you want to build today?",
